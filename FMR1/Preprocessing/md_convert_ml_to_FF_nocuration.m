function out = md_convert_ml_to_FF_nocuration(animID,animDir,sessionNums,varargin)
...
for s = 1:length(sessionNums)
    ...
    posFile = dir([animDir filesep animID 'pos' sprintf('%02i', sessionNum) '.mat']);
    ...
    if strcmp(timeFile(end-2:end),'prv')
        try
            ...
            rawDir = '/media/jadhav/DATA/Justin/PFC_SWRcausal/JS50/';
    ...
    if ~isempty(posFile)
        ...
        warning('No position file found in %s', animDir);
    end
            ...
            for m=1:Nclust
                ...
                if isempty(tag)
                    ...
                    if sum(idx)
                        ...
                        spikes{sessionNum}{l}{tetNum}{end+1} = [];
                    end
