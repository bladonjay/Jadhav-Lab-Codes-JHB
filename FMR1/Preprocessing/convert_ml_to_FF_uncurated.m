function out = convert_ml_to_FF_uncurated(animID,animDir,sessionNums,varargin)
...
if isempty(dayfolders)
    animDir=animDir(1:strfind(animDir,'MountainSort')-2);
    dayfolders = dir([animDir filesep 'MountainSort']);
end
...
for s = 1:length(sessionNums)
    ...
    if strcmp(timeFile(end-2:end),'prv')
        try
            ...
            rawDir = '/media/jadhav/CS_RawData_1/Data/OdorPlaceAssociation/';
