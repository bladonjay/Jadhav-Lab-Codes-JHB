...
%% Generate the behavioral DIO data
ratinfo=fileList;
...
if ~isfield(ratinfo,'ratsamples')
    ...
    for i=1:length(ratinfo)
        ...
        % check which task we are using...
        if contains(DataFile.Var2(1),'socialExperiment_randomWell') %if its the social task
