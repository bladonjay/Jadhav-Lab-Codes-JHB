        ...
        for c = 1:size(cells,1)
            ...
            for e = epochs'
                ...
                stemlength = linpos{d}{e}.segmentInfo.segmentLength(1);
                 stemfield_l = linfields{d}{e}{cell(1)}{cell(2)}{1}(linfields{d}{e}{cell(1)}{cell(2)}{1}(:,1) <= stemlength,5);
                 stemfield_r = linfields{d}{e}{cell(1)}{cell(2)}{3}(linfields{d}{e}{cell(1)}{cell(2)}{3}(:,1) <= stemlength,5);
                fields_l = stack(fields_l,stemfield_l');
                fields_r = stack(fields_r, stemfield_r');
                else
                    continue
                end
            end
...
[bad,~] = find(isnan(comps));
    ...
    figfile = [figDir, 'PlaceFields\SI-SplitterCorrelation_', region];
