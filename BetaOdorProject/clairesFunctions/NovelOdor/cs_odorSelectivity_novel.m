...
region = regions{r};
    ...
    for a = 1:length(animals)
        ...
        cellfilter = ['((strcmp($type, ''pyr'')) && (isequal($area,''',region, ... 
            ''')) && (~isempty($selectivity_prelearn) || ~isempty($selectivity_postlearn)))'];
...
%     [cmap]=buildcmap('rkg'); 
    ...
    %save
       figfile = [figDir,'OdorSelectivity\OdorSelectivity_novel_',region,'_Correct'];
...
%     i_smoothed = zeros(length(validinds));
    ...
    %save
       figfile = [figDir,'OdorSelectivity\OdorSelectivity_novel_',region,'_Incorrect'];
       %saveas(gcf,figfile,'fig');
       print('-dpdf', figfile);
       print('-djpeg',figfile);
    ...
    %save
       figfile = [figDir,'OdorSelectivity\OdorSelectivity_novel_',region,'_SICorrelation'];
       %saveas(gcf,figfile,'fig');
       print('-dpdf', figfile);
       print('-djpeg',figfile);
