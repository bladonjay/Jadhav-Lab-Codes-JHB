...
topRawDir= 'D:\OdorPlaceAssociation\CS33Expt\CS33\'; % raw directory (contains one folder for each day of an experiment ONLY)
dataDir= 'D:\OdorPlaceAssociation\CS33Expt\CS33_direct\';    % data directory
animID= 'CS33';     % your animals name
...
% tetrode metadata (which tetrode is in which area, which is reference)
 ...
 refDataTemplate = [32 0 32 32 0 0 12 12 12 12 12 0 12 12 0 12 32 32 32 32 0 12 12 0 12 12 32 32 32 32 32 32];
...
for sessionNum= 5:6
     ...
     sj_updatetaskenv(   dataDir,animID,sessionNum,[2,4], 'novel1');
end
...
addpath('D:\OdorPlaceAssociation\CS33Expt\CS33_direct\EEG');
for sessionNum= 1:numDays
...
% 
sjcs_baselinespecgram(animID, 1:numDays, 2, [CA1, PFC, OB], 1,'fpass',[0 20],'movingwin',[2000 40]/1000);
sjcs_baselinespecgram(animID, 5:6, 4, [CA1, PFC, OB], 1,'fpass',[0 40],'movingwin',[1000 20]/1000);
sjcs_baselinespecgram(animID, 1:numDays, 2, [CA1, PFC, OB, hpcRef, pfcRef], 0,'fpass',[0 40],'movingwin',[1000 20]/1000);
sjcs_baselinespecgram(animID, 1:numDays, 2, [CA1, PFC, OB, hpcRef, pfcRef], 0,'fpass',[0 100],'movingwin',[400 20]/1000);
