...
save([topDir, 'AnalysesAcrossAnimals\significantPDI_NP_IN.mat'], 'significantPDI');
save([topDir, 'AnalysesAcrossAnimals\PV_IN.mat'], 'PV');
...
for r = 1:length(regions)
    ...
    figtitle = ['EnsemblePDI_NP_IN',region];
