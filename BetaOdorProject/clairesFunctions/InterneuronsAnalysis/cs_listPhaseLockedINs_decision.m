    ...
    for er = 1:length(eegregions)
        ...
        for cr = 1:length(cellregions)
            ...
            for a = 1:length(animals)
                ...
                try
                load([animDir,'PhaseLocking\Interneurons\',animal,'phaselock_',freq,'_decision_',cellregion,'-',eegregion,'.mat'])
                catch
                    continue
                end
            ...
            save([dataDir,'plINs_decision_',freq,'_',cellregion,'-',eegregion,'.mat'], 'plcells');
        end
    end
end