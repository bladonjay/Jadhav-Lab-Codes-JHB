...
for r = 1:length(regions)
    ...
    for j = 1:size(cells,1)
        ...
        if ~isequal(animaldayind, prevanimalday)
            ...
            load([animDir, animal,'odorOffset',daystr,'.mat'])
...
save([topDir, 'AnalysesAcrossAnimals\significantPDI_odoroff.mat'], 'significantPDI');
save([topDir, 'AnalysesAcrossAnimals\PV_odoroff.mat'], 'PV');
...
for r = 1:length(regions)
    ...
    figtitle = ['EnsemblePDI_NP_odoroff_',region];
