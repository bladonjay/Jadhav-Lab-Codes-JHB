...
for r = 1:length(regions)
    ...
    for w = 1:length(wins)
        ...
        for a = 1:length(animals)
            ...
            for day = days'
                ...
                if strcmp(region,'all')
                    ...
                    [fract_correct, fract_correct_shuff] = cs_predictChoice_GLM_v3(animal, day, region, window,celltype);
        ...
        save([topDir, 'AnalysesAcrossAnimals\predict',predict,'GLM_v2_',region,celltag],'Acc_mn','Acc','Acc_shuff','wins');
