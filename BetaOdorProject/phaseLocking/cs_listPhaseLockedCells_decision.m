    ...
    for er = 1:length(eegregions)
        ...
        for cr = 1:length(cellregions)
            ...
            for a = 1:length(animals)
                ...
                load([animDir,'PhaseLocking\',animal,'phaselock_decision_',freq,'_',cellregion,'-',eegregion,'.mat'])
            ...
            save([dataDir,'plCells_decision_',freq,'_',cellregion,'-',eegregion,'.mat'], 'plcells');
        end
    end
end