...
%                 figure, plot(pos{day}{epoch}.data(:,2), pos{day}{epoch}.data(:,3),'k.');
            ...
            for c = 1:size(daycells,1)
                ...
                if ~isempty(allspikes)
                    ...
                    g = gaussian2(std,(5*std));
                    smoothedspikerate = filter2(g,(spikerate)); % is this the right filter?
                    %smoothedoccupancy = [];
                    ...
                    z = find(smoothedoccupancy <= threshocc);
                    ...
                    smoothedoccupancy(z) = -1;
                    
                    smoothedspikerate(z) = -1;
                    ...
                    colorbar
                    title([animal, ' ', region, ' ', num2str(day), ' ', num2str(cell(1)), ' ', num2str(cell(2)), ' SI= ', num2str(SI)]);
%                     pause
                    close
