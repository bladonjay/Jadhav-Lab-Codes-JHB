...
for r = 1:length(regions)
    ...
    for w = 1:length(wins)
        ...
        for a = 1:length(animals)
            ...
            for day = days'
                ...
                if strcmp(region,'all')
                    ...
                    switch predict
                        case 'Choice'
                            [fract_correct, fract_correct_shuff] = cs_predictChoice_GLM_IN(animal, day, region, window,celltype);
                        case 'Outcome'
        ...
        save([topDir, 'AnalysesAcrossAnimals\predict',predict,'GLM_IN_',region,celltag],'Acc_mn','Acc','Acc_shuff','wins');
