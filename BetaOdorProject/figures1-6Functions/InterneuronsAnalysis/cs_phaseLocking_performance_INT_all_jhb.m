...
%
%
% in lines 47 and 53, the 2 at the end is for the new taskResponsive data
%
%
%
%
...
for cr = 1:length(cellregions)
    ...
    for er=1:length(eegregions)
        ...
        for a = 1:length(animals)
            ...
            try
                load([animDir,'PhaseLocking\Interneurons\',animal,'phaselock_',band,'_',cellregion,'-',eegregion,'2']);
            catch
                continue
            end
            phaselock_correct = phaselock;
            try
                load([animDir,'PhaseLocking\Interneurons\Incorrect\',animal,'phaselock_',band,'_incorrect_',cellregion,'-',eegregion,'2']);
