...
for r = 1:length(regions)
    ...
    for l = 1:length(learningtypes)
        ...
        for a = 1:length(animals)
            ...
            filt = ['strcmp($area, ''',region,''') && (strcmp($selectivity, ''',lcellfilt,''') || strcmp($selectivity, ''',rcellfilt,'''))'];
                    ...
                    if sumspikes >= length(trigs_all)
                        ...
                        for e = 1:length(runeps)
                            ...
                            if length(cellinfo{cell(1)}{epoch}{cell(2)}) >= cell(3)
                                if trueIndexZ >= 1.5
                                    cellinfo{cell(1)}{epoch}{cell(2)}{cell(3)}.selectivity = ['novelLeftSelective_',learning];
                                    
                                elseif trueIndexZ <= -1.5
                                    cellinfo{cell(1)}{epoch}{cell(2)}{cell(3)}.selectivity = ['novelRightSelective_',learning];
