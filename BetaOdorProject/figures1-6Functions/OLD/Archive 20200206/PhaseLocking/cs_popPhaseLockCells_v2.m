    ...
    for cr = 1:length(cellregions)
        ...
        for a = 1:length(animals)
            ...
            for d = days'
                ...
                if isfile([animDir,'PhaseLocking\',animal,freq,'phaselock_',region,'-',eegregion,'_',daystr,'.mat'])
                    load([animDir,'PhaseLocking\',animal,freq,'phaselock_',region,'-',eegregion,'_',daystr]);
                else 
                    continue
                end
