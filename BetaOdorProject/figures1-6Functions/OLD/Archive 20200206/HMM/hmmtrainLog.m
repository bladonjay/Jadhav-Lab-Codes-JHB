function [guessTR,guessE,logliks] = hmmtrainLog(seqs,guessTR,guessE,varargin)
...
%   $Revision: 1.4.4.6 $  $Date: 2004/12/24 20:46:52 $
...
for iteration = 1:maxiter
    ...
    if any(totalTransitions == 0)
        ...
        guessTR(noTransitionRows,noTransitionRows) = 1;
    end
