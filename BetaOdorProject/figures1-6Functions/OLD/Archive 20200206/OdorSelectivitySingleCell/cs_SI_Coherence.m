...
cellregions = {'CA1','PFC'};
betaregions = {'CA1-PFC','CA1-OB','PFC-OB'};
numtrials = 10;
freq = 'beta';
    ...
    for a = 1:length(animals)
        ...
        for day = days'
            ...
            for ep = eps'
                ...
                load([animDir, animal, 'coherence',betaregion, daystr]);
...
legend({['Low ',freq,' Coherence'],['High ',freq,' Coherence']})
