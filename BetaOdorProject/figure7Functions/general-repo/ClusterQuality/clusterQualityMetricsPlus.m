function [ ClusterQualityStruct ] = clusterQualityMetricsPlus( curDir, fileList )
...
for iTetrode = 1:nTetrodes
    ...
    waveformFeatureMat = importdata(strcat(curDir,fileList{iTetrode}),'\t',1);
    ...
    for j = 1:nClusters
        if size(featureMatrix(:,unitIndex == j),2)>20
