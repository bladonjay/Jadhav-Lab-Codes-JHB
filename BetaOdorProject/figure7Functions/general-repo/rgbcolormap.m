% RGBcolormap  Rgb triple for given CSS color name
%
%   RGB = RGBcolormap('COLORNAME') returns the red-green-blue triple corresponding
...
%
%   RGBcolormap CHART creates a figure window showing all the available colors with
%     their names.
%
%   EXAMPLES
%     c = rgbcolormap('DarkRed')               gives c = [0.5430 0 0]
%     c = rgbcolormap('Green')                 gives c = [0 0.5 0]
%     plot(x,y,'color',rgbcolormap('orange'))  plots an orange line through x and y
%     rgbcolormap chart                        shows all the colors
%
%   BACKGROUND
...
function rgbcolor = rgbcolormap(s)
% RGB = RGBcolormap('chart')
