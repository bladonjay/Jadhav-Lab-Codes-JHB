...
%
% INPUT:
%   filename - if empty string, will tell you to input string
...
if(ischar(filename) == 0)
    disp('first variable input argument should be file name')
    return
end

if(ischar(varname) == 0)
    disp('second var input arguments should be variable names')
    return
end
...
% this line below is commented out so that it doesnt show up when its
%called on on NexToArray
